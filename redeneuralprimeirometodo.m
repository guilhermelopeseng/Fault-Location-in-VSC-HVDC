...
%Simulação de treinamento da RNA para o primeiro método
...
resisntecia_treinamento(1,:) = treinamento(quant_entradas+2,:);
...
save('./resultados_redes_neurais/primeiro_metodo_polo_terra.mat');
...
save('./resultados_redes_neurais/primeiro_metodo.mat');
